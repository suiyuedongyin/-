...
unsigned char code *Main_Menu0[]=
{
{"    欢迎使用"},
{"  智能云考勤机"}
};

unsigned char code *Main_Menu1[]=
{
{"  指纹识别系统"},
{"  是否验证指纹?"}
};

unsigned char code *Main_Menu2[]=
{
{"  密码签到系统"},
{"  是否输入密码?"}
};
...
{   
 	ClrScreen();
    LCD_PutString(0,1,Main_Menu0[0]);    
	  LCD_PutString(0,3,Main_Menu0[1]);   //windows环境下可以直接写汉字
	
}	 	
void DisplayUpdata1(void)
{   
 	ClrScreen();
    LCD_PutString(0,1,Main_Menu1[0]);    
	  LCD_PutString(0,3,Main_Menu1[1]);   //windows环境下可以直接写汉字
	
}
void DisplayUpdata2(void)
{   
 	ClrScreen();
    LCD_PutString(0,1,Main_Menu2[0]);    
	  LCD_PutString(0,3,Main_Menu2[1]);   //windows环境下可以直接写汉字
